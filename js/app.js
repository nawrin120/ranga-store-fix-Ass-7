...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <small class="rating text-secondary"><i class="fas fa-star icon"></i><i class="fas fa-star icon"></i><i class="fas fa-star icon"></i><i class="far fa-star icon"></i><span class="text-dark fw-bolder">(${product.rating.rate})</span></small><br>
      <small class="rating"><i class="fas fa-user fs-6"></i> <sapn class="text-dark">${product.rating.count}</sapn></small><br><br>

      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="button-design">Add to cart</button>
      <button id="details-btn" class="button-design">Details</button></div>
      `;
